 ...
 */
object CRC {
    const final val ANIMAS_INITIAL_REMAINDER = 0xFFFF
    const final val ANIMAS_FINAL_XOR = 0
    const final val DEXCOM_INITIAL_REMAINDER = 0
    const final val DEXCOM_FINAL_XOR = 0

    final val CRC_TABLE = intArrayOf(
