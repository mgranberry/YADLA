...
class VersionReq : TandemPayload {
    companion object {
        const val COMMAND: Int = 82
    }

    override val id: Int get() = COMMAND
}
...
data class LogEntrySeqReq(val seqNum: Long) : TandemPayload {
    companion object {
        const val COMMAND: Int = 151
    }
...
class LogEntrySeqMultiReq : TandemPayload {
    companion object {
        const val COMMAND: Int = 152
    }

    override val id: Int get() = COMMAND
}

data class LogEntrySeqMultiStopDump(val seqNum: Long,
                                    val howMany: Long) : TandemPayload {
    companion object {
        const val COMMAND: Int = 153
    }
...
class LogSizeReq : TandemPayload {
    companion object {
        const val COMMAND: Int = 168
    }

    override val id: Int get() = COMMAND
}

data class LogSizeResp(val numEntries: Int,
                       val firstSeqNo: Int,
                       val lastSeqNo: Int) : TandemPayload {
...
data class IdpReq(val idp: Int) : TandemPayload {
    companion object {
        const val COMMAND: Int = 175
    }
