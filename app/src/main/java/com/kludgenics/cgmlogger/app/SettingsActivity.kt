...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            if (title == getString(R.string.title_activity_settings)) {
                startActivity(Intent(this, MainActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK))
            } else {
                startActivity(Intent(this, SettingsActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK))
            }
            return true
        }
    ...
    class DataSyncPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val ps = preferenceManager.createPreferenceScreen(context)
            ps.title = "Foo"
