...
class DailyAgp(val period: Period = Period.days(30), percentileValues: DoubleArray = DailyAgp.STANDARD_PERCENTILES) {
    val TAG = "DailyAgp"

    val percentiles : DoubleArray by Delegates.lazy {
        getAgp(period, percentileValues)
    }

    companion object {
        val SPEC_HEIGHT = 360.0
        val SPEC_WIDTH = 240.0
    ...
    private fun getAgp(period: Period = Period.days(30), percentileValues: DoubleArray = STANDARD_PERCENTILES): DoubleArray {
